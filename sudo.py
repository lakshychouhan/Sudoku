...
class Cube:
    ...
    def draw(self, win):
        ...
        if self.selected:
            pygame.draw.rect(win, (0,255,255), (x,y, gap ,gap), 3)
    ...
    def draw_change(self, win, g=True):
        ...
        if g:
            ...
            pygame.draw.rect(win, (0, 0, 250), (x, y, gap, gap), 3)
...
def redraw_window(win, board, time, strikes):
    ...
    if board.is_finished() or strikes >= 5:
        game_over_text = fnt.render("Game Over", 1, (255, 0, 0))
...
def main():
    ...
    while run:
        ...
        if board.selected and key != None:
            board.sketch(key)
        if board.is_finished() :  # Check for game completion
            pygame.time.delay(3000)  # Add a 3-second delay
            game_over = True
